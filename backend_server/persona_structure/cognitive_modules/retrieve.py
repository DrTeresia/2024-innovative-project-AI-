import sys
sys.path.append('../../')
from backend_server.persona_structure.prompt_template.gpt_structure import *

from numpy import dot
from numpy.linalg import norm

def retrieve(persona, perceived_info):
    """
    :param persona: 将领
    :param perceived_info: 从 perceive 方法获得的信息
    :return: 根据获得信息和现有 memory 中的信息检索出当前决策
    """
    retrieved = dict()
    for event in perceived_info:
