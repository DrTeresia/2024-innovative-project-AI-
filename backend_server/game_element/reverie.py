...
from backend_server.persona_structure.cognitive_modules.converse import *
from backend_server.utils import *
from backend_server.game_element.map import *
...
class ReverieServer:
    def __init__(self,
        ...
        self.maze = Map(reverie_meta['maze_name'])
